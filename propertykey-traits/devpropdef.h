...
// Force CPP to search for the 'next' devpropdef.h file in the include path
#include_next <devpropdef.h>
...
static_assert(RuntimePropertyKeyConcept<DEVPROPKEY>);
...
{
    inline bool
    operator==(const DEVPROPKEY &a, const DEVPROPKEY &b)
    {
...
{
    inline bool
    operator==(const DEVPROPCOMPKEY &a, const DEVPROPCOMPKEY &b)
    {
